...
export namespace Endpoints {
  ...
  export type patch__user_updateAttributes = {
    ...
    response: {
      success: boolean;
      message: string;
      user?: { id: string; name: string; displayName: string | null; email: string; image: string | null } | undefined;
    };
  };
  ...
  export type post__personal_refreshDiscord = {
    ...
    response: {
      success: boolean;
      message: string;
      user?: { id: string; name: string; email: string; image: string | null; username: string | null } | undefined;
    };
  };
