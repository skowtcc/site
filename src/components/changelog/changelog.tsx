...
const changelogItems = [
    {
        ...
        title: 'v3.0.15b Cleanup',
        description:
            'The frontend codebase for skowt is honestly a mess, as my main focus (as the sole developer of skowt) is on Originoid, I will be slowly working over the next couple weeks to make the site more "clean"',
    },
    {
...
// Auto-generate IDs based on array position (newest first = ID 1)
const items = changelogItems.map((item, index) => ({
    ...item,
    id: index + 1,
}))
...
export default function Component() {
    return (
        <div className="bg-card px-6 py-8 border rounded-xl">
