...
export function Footer() {
    return (
        <div className="flex flex-col gap-4 p-4 w-full bg-card border-t border-border">
            ...
            <p className="text-xs text-muted-foreground text-center">
                skowt.cc is a free to use service provided by Originoid LTD. Company no. 15988228. ICO Registration no.
                ZB857511.
                <br />
